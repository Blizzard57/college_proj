...
public class LaneEvent {
	...
	public LaneEvent( Party pty, int theIndex, Bowler theBowler, int[][] theCumulScore, HashMap theScore, int theFrameNum, int[] theCurScores, int theBall, boolean mechanicalProblem) {
		p = pty;
		index = theIndex;
		bowler = theBowler;
