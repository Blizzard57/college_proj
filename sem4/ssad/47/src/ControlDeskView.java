...
public class ControlDeskView implements ActionListener, ControlDeskObserver {
	...
	private JButton addParty, finished, queries;
	private JFrame win;
	...
	public ControlDeskView(ControlDesk controlDesk, int maxMembers) {
		...
		queries = new JButton("Queries/Scores");
		JPanel queriesPanel = new JPanel();
		queriesPanel.setLayout(new FlowLayout());
		queries.addActionListener(this);
		queriesPanel.add(queries);
		controlsPanel.add(queriesPanel);
	...
	public static void queriesLane(){
